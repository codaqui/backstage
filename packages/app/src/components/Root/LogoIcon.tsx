  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_icon)">
        <path
          d="M9.34459 30.3027L19.3496 21.8515L17.6179 19.8133L7.61288 28.2645L9.34459 30.3027Z"
          fill={isDarkMode ? 'white' : '#3A2F39'}
        />
        <path
          d="M18.7364 19.0544L10.2605 9.0786L8.2164 10.8053L16.6923 20.7811L18.7364 19.0544Z"
          fill={isDarkMode ? 'white' : '#3A2F39'}
        />
        <path
